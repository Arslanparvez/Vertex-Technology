...
const milestones = [
  ...
  { year:'2008', title:'Vertex Technology Launch',   desc:'Launched proprietary brand "Vertex Technology" — manufactured in UAE to global quality standards.' },
            ...
            <ScrollReveal direction="right">
              <div className="relative">
                ...
                <div className="absolute -bottom-5 -right-5 bg-[#0D2848] text-white rounded-2xl p-6 shadow-xl">
                  ...
                  <div className="text-[#7DD3F5] text-xs mt-0.5">Founded in Dubai</div>
                </div>
              </div>
            </ScrollReveal>
                  ...
                  <div className={`flex flex-col lg:flex-row items-center gap-6 ${i%2===0?'':'lg:flex-row-reverse'}`}>
                    <div className={`flex-1 ${i%2===0?'lg:text-right':''}`}>
                      <div className="card p-6 inline-block w-full lg:max-w-sm">
                        <div className="text-[#1264D6] font-black text-2xl mb-1">{m.year}</div>
